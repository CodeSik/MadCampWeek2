...
public class FeedItemAnimator extends DefaultItemAnimator {
    ...
    public boolean animateAdd(RecyclerView.ViewHolder viewHolder) {
        if (viewHolder.getItemViewType() == GalleryAdapter.VIEW_TYPE_DEFAULT) {
            if (viewHolder.getLayoutPosition() > lastAddAnimatedItem) {
                lastAddAnimatedItem++;
                runEnterAnimation((GalleryAdapter.CellFeedViewHolder) viewHolder);
                return false;
            }
        }
    ...
    private void runEnterAnimation(final GalleryAdapter.CellFeedViewHolder holder) {
    ...
    public boolean animateChange(@NonNull RecyclerView.ViewHolder oldHolder,
        ...
        if (preInfo instanceof FeedItemHolderInfo) {
            ...
            GalleryAdapter.CellFeedViewHolder holder = (GalleryAdapter.CellFeedViewHolder) newHolder;

            animateHeartButton(holder);
            updateLikesCounter(holder, holder.getFeedItem().likesCount);
            if (GalleryAdapter.ACTION_LIKE_IMAGE_CLICKED.equals(feedItemHolderInfo.updateAction)) {
    ...
    private void animateHeartButton(final GalleryAdapter.CellFeedViewHolder holder) {
    ...
    private void updateLikesCounter(GalleryAdapter.CellFeedViewHolder holder, int toValue) {
    ...
    private void animatePhotoLike(final GalleryAdapter.CellFeedViewHolder holder) {
    ...
    private void dispatchChangeFinishedIfAllAnimationsEnded(GalleryAdapter.CellFeedViewHolder holder) {
    ...
    private void resetLikeAnimationState(GalleryAdapter.CellFeedViewHolder holder) {
