...
public class PetrolModeFragment extends Fragment {
    ...
    public PetrolModeFragment() {
        //required public constructor
    }

    public static PetrolModeFragment newInstance(String currentLat, String currentLon, String token) {
        mCurlat = currentLat;
        mCurlon = currentLon;
        mToken = token;
        return new PetrolModeFragment();
    }
