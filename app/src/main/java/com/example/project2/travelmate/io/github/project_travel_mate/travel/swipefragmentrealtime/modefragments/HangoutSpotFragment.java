...
public class HangoutSpotFragment extends Fragment {
    ...
    public static HangoutSpotFragment newInstance(String currentLat, String currentLon, String token) {
        mCurlat = currentLat;
        mCurlon = currentLon;
        mToken = token;
        return new HangoutSpotFragment();
    }
