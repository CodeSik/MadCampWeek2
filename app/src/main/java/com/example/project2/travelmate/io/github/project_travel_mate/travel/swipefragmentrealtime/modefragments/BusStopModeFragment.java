package com.example.project2.travelmate.io.github.project_travel_mate.travel.swipefragmentrealtime.modefragments;
...
import com.example.project2.travelmate.io.github.project_travel_mate.travel.swipefragmentrealtime.MapListItemAdapter;
...
public class BusStopModeFragment extends Fragment {
    ...
    public BusStopModeFragment() {
        //required public constructor
    }

    public static BusStopModeFragment newInstance(String currentLat, String currentLon, String token) {
        mCurlat = currentLat;
        mCurlon = currentLon;
        mToken = token;
        return new BusStopModeFragment();
    }
    ...
    /**
     * Gets all nearby bus stops/Railway stations
     */
    private void getPlaces() {
        Handler handler = new Handler(Looper.getMainLooper());

        String uri = API_LINK_V2 + "get-places/" + mCurlat + "/" + mCurlon
                + "/" + HERE_API_MODES.get(3);
