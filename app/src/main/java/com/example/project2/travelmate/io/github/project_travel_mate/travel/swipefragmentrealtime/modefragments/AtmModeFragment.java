...
public class AtmModeFragment extends Fragment {
    ...
    public AtmModeFragment() {
        //required public constructor
    }

    public static AtmModeFragment newInstance(String currentLat, String currentLon, String token) {
        mCurlat = currentLat;
        mCurlon = currentLon;
        mToken = token;
        return new AtmModeFragment();
    }
